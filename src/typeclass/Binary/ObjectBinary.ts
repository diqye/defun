 ...
 * - Uint8Array
 */
export const ObjectBinary = Binary<JSONValue>({
        ...
        switch (typeTag) {
            ...
            case TypeTag.ARRAY:
                ...
                for (let i = 0; i < length; i++) {
                    array.push(ObjectBinary.get(reader))
                }
                return array
            ...
            case TypeTag.OBJECT:
                ...
                for (let i = 0; i < count; i++) {
                    ...
                    const value = ObjectBinary.get(reader)
                    obj[key] = value
                }
                return obj
            default:
